...
module multdiv(input         clk,
  ...
  // control logic
  mdcontroller mdcont(clk, reset, start, run, done, init, muldivb, 
  ...
  flopenr        prodlreg(clk, reset, run, nextprodl, 
...
module mdcontroller(input            clk,
  ...
  flopen #(2) controlreg(clk, start, {muldivb, signedop}, 
  ...
  flopenr #(1) signdisagreereg(clk, reset, start, xsign ^ ysign, 
                               signsdisagree);
